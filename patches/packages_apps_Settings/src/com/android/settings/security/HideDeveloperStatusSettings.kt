...
/**
 * Fragment for managing which apps should have developer status hidden.
 * Shows a list of installed apps with checkboxes to select which ones
 * should see developer options as disabled.
 */
